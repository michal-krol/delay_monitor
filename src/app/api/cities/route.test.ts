...
describe('GET /api/cities', () => {
  ...
  // resetu modułów drugie wywołanie `call()` w tym pliku trafiałby w cache
  // pierwszego zamiast wołać `searchStations` ponownie, gubiąc
  // `mockRejectedValueOnce` ustawione niżej.
  beforeEach(() => {
    vi.resetModules()
  })
