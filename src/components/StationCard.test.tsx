...
describe('StationCard', () => {
  it('shows the station name and up to 3 departures with delay text (not color-only)', () => {
    const snapshot = makeSnapshot({
      departures: [
        { scheduleId: '1', orderId: '1', operatingDate: '2026-08-01', trainNumber: '1', trainLabel: 'EIC 1', carrier: 'IC', carrierName: null, category: 'EIC', headsign: 'Kraków', plannedAt: new Date(Date.now() + 5 * 60000).toISOString(), actualAt: null, delayMinutes: 5, status: 'delayed', platform: '1' },
      ],
    })
  ...
  it('shows only the short carrier code (not the full legal name) next to the logo, on any viewport', () => {
    const snapshot = makeSnapshot({
      departures: [
        { scheduleId: '1', orderId: '1', operatingDate: '2026-08-01', trainNumber: '1', trainLabel: 'EIC 1', carrier: 'IC', carrierName: '„PKP Intercity” Spółka Akcyjna', category: 'EIC', headsign: 'Kraków', plannedAt: new Date(Date.now() + 5 * 60000).toISOString(), actualAt: null, delayMinutes: 0, status: 'onTime', platform: '1' },
      ],
    })
  ...
  it('falls back to a generic label when the carrier code is empty', () => {
    const snapshot = makeSnapshot({
      departures: [
        { scheduleId: '26-1', orderId: '26-1', operatingDate: '2026-08-01', trainNumber: '26-1', trainLabel: '26-1', carrier: '', carrierName: null, category: '', headsign: 'Kraków', plannedAt: new Date(Date.now() + 5 * 60000).toISOString(), actualAt: null, delayMinutes: 0, status: 'onTime', platform: null },
      ],
    })
  ...
  it('shows the departure time for each of the 3 nearest departures', () => {
    ...
    const snapshot = makeSnapshot({
      departures: [
        { scheduleId: '1', orderId: '1', operatingDate: '2026-08-01', trainNumber: '1', trainLabel: 'EIC 1', carrier: 'IC', carrierName: null, category: 'EIC', headsign: 'Kraków', plannedAt, actualAt: null, delayMinutes: 0, status: 'onTime', platform: '1' },
      ],
    })
  ...
  it('shows the platform/track on the tile', () => {
    const snapshot = makeSnapshot({
      departures: [
        { scheduleId: '1', orderId: '1', operatingDate: '2026-08-01', trainNumber: '1', trainLabel: 'EIC 1', carrier: 'IC', carrierName: null, category: 'EIC', headsign: 'Kraków', plannedAt: new Date(Date.now() + 5 * 60000).toISOString(), actualAt: null, delayMinutes: 0, status: 'onTime', platform: '4/2' },
      ],
    })
  ...
  it('shows a dash for the platform/track on the tile when unknown', () => {
    const snapshot = makeSnapshot({
      departures: [
        { scheduleId: '1', orderId: '1', operatingDate: '2026-08-01', trainNumber: '1', trainLabel: 'EIC 1', carrier: 'IC', carrierName: null, category: 'EIC', headsign: 'Kraków', plannedAt: new Date(Date.now() + 5 * 60000).toISOString(), actualAt: null, delayMinutes: 0, status: 'onTime', platform: null },
      ],
    })
  ...
  it('excludes departures that already passed, keeping only upcoming ones (past ones stay in FullBoard only)', () => {
    const past = { scheduleId: '1', orderId: '1', operatingDate: '2026-08-01', trainNumber: '1', trainLabel: 'PAST1', carrier: 'IC', carrierName: null, category: 'EIC', headsign: 'Kraków', plannedAt: new Date(Date.now() - 2 * 60000).toISOString(), actualAt: null, delayMinutes: 0, status: 'onTime' as const, platform: '1' }
    const future = { scheduleId: '2', orderId: '2', operatingDate: '2026-08-01', trainNumber: '2', trainLabel: 'FUTURE2', carrier: 'IC', carrierName: null, category: 'EIC', headsign: 'Kraków', plannedAt: new Date(Date.now() + 10 * 60000).toISOString(), actualAt: null, delayMinutes: 0, status: 'onTime' as const, platform: '1' }
  ...
  it('shows an error message without hiding the last known snapshot', () => {
    const snapshot = makeSnapshot({
      departures: [
        { scheduleId: '1', orderId: '1', operatingDate: '2026-08-01', trainNumber: '1', trainLabel: 'EIC 1', carrier: 'IC', carrierName: 'PKP Intercity', category: 'EIC', headsign: 'Kraków', plannedAt: new Date(Date.now() + 5 * 60000).toISOString(), actualAt: null, delayMinutes: 0, status: 'onTime', platform: '1' },
      ],
    })
